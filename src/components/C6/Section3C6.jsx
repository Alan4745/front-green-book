        ...
        >
            ...
            <div className="lg:hidden flex min-h-screen flex-col justify-center min-[744px]:max-[1023px]:justify-start pt-[7vh] min-[744px]:max-[1023px]:pt-[8vh] pb-[10vh] min-[744px]:max-[1023px]:pb-[6vh] text-white">
                ...
                <div className="relative px-6 min-[744px]:max-[1023px]:px-10 py-[3vh] min-[744px]:max-[1023px]:py-[2vh]">
                    <div className="text-[28vw] md:text-[18vw] min-[744px]:max-[1023px]:text-[15vw] font-bold opacity-30 leading-none" style={{ fontFamily: "GothamBold" }}>05</div>
                ...
                {/* Bloque 06 */}
                <div className="relative px-6 min-[744px]:max-[1023px]:px-10 py-[3vh] min-[744px]:max-[1023px]:py-[2vh]">
                    <div className="text-[28vw] md:text-[18vw] min-[744px]:max-[1023px]:text-[15vw] font-bold opacity-30 leading-none text-right" style={{ fontFamily: "GothamBold" }}>06</div>
