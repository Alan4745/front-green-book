        ...
        >
            ...
            <div className="lg:hidden flex flex-col text-white">
                ...
                <div className="relative px-6 pt-8 pb-4">
                    <div className="text-[28vw] md:text-[18vw] font-bold opacity-30 leading-none" style={{ fontFamily: "GothamBold" }}>03</div>
                ...
                <div className="relative px-6 pt-4 pb-8">
                    <div className="text-[28vw] md:text-[18vw] font-bold opacity-30 leading-none text-right" style={{ fontFamily: "GothamBold" }}>04</div>
