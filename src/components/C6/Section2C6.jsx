        ...
        {/* Contenido de la sección */}
            <div className="relative w-full text-white">
                ...
                <h3 className="text-3xl font-bold uppercase" style={{ fontFamily: "GothamBold" }}>
                    Mitigando el <br /> cambio climático
                </h3>
                {/* Número grande 03 */}
                ...
                <p className="text-[2vh] leading-relaxed" style={{ fontFamily: "GothamNormal" }}>
                    Sistemas agroforestales que capturan el <br />
                    carbono y minimizan el impacto de la <br />
                ...
                <p className="text-[2vh] leading-relaxed" style={{ fontFamily: "GothamNormal" }}>
                    Desarrollo económico y social a largo <br />
                    plazo para caficultores y comunidades <br />
                    enteras.
                </p>
                </div>
