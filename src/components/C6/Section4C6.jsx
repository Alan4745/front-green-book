...
const Section4C6 = () => {
    ...
    const descriptionTextSize = windowWidth > 1600 ? "text-[2.1vh]" : "text-[2.1vh]"; // Descripción más grande para pantallas grandes
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full text-white">
                ...
                <div className={`absolute ${descriptionTop} ${descriptionLeft} max-w-[42vh] text-justify`}>
                ...
                <div className={`absolute ${descriptionTop} ${descriptionRight} text-right max-w-[47vh]`}>
                    <p className={`${descriptionTextSize} leading-relaxed`} style={{ fontFamily: 'GothamNormal' }}>
