...
const Carrousel = () => {
    ...
    const cards = useMemo(() => {
        ...
        return [
            ...
            { text: "UN ENTORNO DIVERSO POR EXPLORAR", bgImage: "/Img/Start/Caps/bg5.webp", chapter: "c5" },
            { text: "SUSTENTABILIDAD QUE TRANSFORMA EL FUTURO DEL CAFÉ", bgImage: "/Img/Start/Caps/bg6.webp", chapter: "c6" },
        ];
        }
        return arr;
    }, [t]);
