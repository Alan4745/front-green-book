...
const Card = ({ text = "Default Text", bgImage = "/Img/Start/Caps/bg1.svg" }) => {
...
return (
    ...
    >
        ...
        <div className="flex justify-end">
            <button className="border-1 border-white border-opacity-50 rounded-full p-2 bg-transparent hover:scale-110 transition-all duration-300">
            <svg
