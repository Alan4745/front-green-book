...
const Capitulo3 = () => {
    return (
        ...
        style={{ backgroundImage: "url('/Img/C3/ImgC3.svg')" }}
        >
        ...
        <div className="absolute top-[20vh] right-[25vh] z-30">
            <img src="/Img/Global/Numbers/03.svg" alt="Capítulo 3" className="w-[50vh] h-auto" />
        </div>
