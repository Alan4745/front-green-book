            ...
            <div className={`absolute inset-0 z-20 transition-opacity duration-300 ${ cleanView ? 'opacity-0 pointer-events-none' : 'opacity-100' }`} >
                ...
                <div className="absolute bottom-6 left-6">
                    <p className='w-[100vh] text-xl' style={{ fontFamily: 'GothamNormal' }}>
                        Anacafé ha posicionado la marca Guatemalan Coffees, para promover el café de nuestro país, el cual es reconocido y valorado por los mercados más exigentes alrededor del mundo.
                    </p>
                    <button
                        type="button"
