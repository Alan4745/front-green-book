        ...
        >
            ...
            <div className="lg:hidden [@media(min-width:1024px)_and_(orientation:portrait)]:!flex flex flex-col h-svh w-full overflow-hidden [@media(orientation:portrait)]:px-3 [@media(orientation:landscape)]:px-4 [@media(orientation:portrait)]:pt-16 [@media(orientation:landscape)]:pt-8 [@media(orientation:portrait)]:pb-4 [@media(orientation:landscape)]:pb-3 [@media(orientation:portrait)]:gap-3 [@media(orientation:landscape)]:gap-2">
                ...
                <div className="shrink-0 flex justify-center items-center px-6
                    ...
                    [@media(min-width:820px)_and_(orientation:portrait)]:!min-h-[48svh]
                    [@media(min-width:820px)_and_(orientation:portrait)]:!py-10
                    [@media(min-width:820px)_and_(orientation:portrait)]:!px-12">
                    <div className="flex flex-col items-center justify-center flex-1 min-w-0">
                        ...
                        <img src={LogotipoGC} alt={t('colab.cover.alts.gcLogotype')} title={t('colab.cover.alts.gcLogotype')}
                            ...
                            className="h-auto max-w-full
                                ...
                                [@media(min-width:820px)_and_(orientation:portrait)]:!w-96
                    ...
                    <div className="w-px rounded-full bg-white shrink-0
                        ...
                        [@media(min-width:820px)_and_(orientation:portrait)]:!h-80 [@media(min-width:820px)_and_(orientation:portrait)]:!mx-12
                ...
                <div className="flex-1 min-h-0 w-full overflow-hidden gap-2 [@media(orientation:portrait)]:grid [@media(orientation:portrait)]:grid-cols-2 [@media(orientation:landscape)]:flex">
                    ...
                    >
                        <div className="absolute top-2 right-2 w-6 h-6 rounded-full bg-[#562E91] flex items-center justify-center shadow-md shrink-0" aria-hidden="true">
                    ...
                    >
                        <div className="absolute top-2 right-2 w-6 h-6 rounded-full bg-[#738720] flex items-center justify-center shadow-md shrink-0" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                            </svg>
                        </div>
