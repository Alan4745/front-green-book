    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-18 right-10">
                <div className="relative w-[90vh] h-[60vh] bg-white/90 backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-white/40 p-6 md:p-8 flex flex-col">
