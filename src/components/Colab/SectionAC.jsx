            ...
            <div className={`absolute inset-0 z-20 transition-opacity duration-300 ${ cleanView ? 'opacity-0 pointer-events-none' : 'opacity-100' }`} >
                ...
                <div className="absolute bottom-6 left-6">
                    <p className='w-[100vh] text-xl' style={{ fontFamily: 'GothamNormal' }}>
                        En Anacafé trabajamos por transformar el futuro del café de Guatemala, desarrollando y ejecutando la política cafetalera nacional, conectando a los caficultores y su producto con oportunidades comerciales a nivel mundial.
                    </p>
                    <button
                        type="button"
                        onClick={() => window.open('https://anacafe.org/')}
                        className="mt-4 text-black py-2 underline underline-offset-6 cursor-pointer"
