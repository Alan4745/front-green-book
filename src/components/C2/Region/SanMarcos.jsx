    ...
    return (
        <div className="flex w-screen h-screen overflow-hidden">
            ...
            <div className="w-[58%] h-full relative">
                ...
                {/* Animación del logo de región San Marcos */}
                <motion.div
                ...
                >
                    <ul className="space-y-2 text-[2.3vh]" style={{ fontFamily: 'GothamNormal' }}>
                        <motion.li
                            ...
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 3.2 }} // De buen cuerpo entra primero
                        >
                        ...
                        <motion.li
                            ...
                            initial={{ opacity: 0, scale: 0.5 }}
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 3.4 }} // Acidez pronunciada entra después
                        >
                            <span className="w-[1.2vh] h-[1.2vh] rounded-full bg-[#DC4C65] inline-block"></span>
                            Acidez pronunciada
                        </motion.li>
                        <motion.li
                            ...
                            initial={{ opacity: 0, scale: 0.5 }}
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 3.6 }} // Notas florales entra después
                        >
                            <span className="w-[1.2vh] h-[1.2vh] rounded-full bg-[#DC4C65] inline-block"></span>
                            Notas florales
                        </motion.li>
