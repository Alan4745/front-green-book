    ...
    return (
        <div className="flex w-screen h-screen overflow-hidden">
            ...
            <div className="w-[58%] h-full relative">
                ...
                {/* Animación del logo de región Huehue */}
                <motion.div
            ...
            <div className="w-[42%] h-full bg-white relative">
                {/* Animación del perfil de la región Huehue */}
                <motion.div
                ...
                >
                    <ul className="space-y-2 text-[2.3vh]" style={{ fontFamily: 'GothamNormal' }}>
                        <motion.li
                            ...
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 3.2 }} // Acidez fina entra primero
                        >
                        ...
                        <motion.li
                            ...
                            initial={{ opacity: 0, scale: 0.5 }}
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 3.4 }} // Cuerpo lleno entra después
                        >
                            <span className="w-[1.2vh] h-[1.2vh] rounded-full bg-[#87247A] inline-block"></span>
                            Cuerpo lleno
                        </motion.li>
                        <motion.li
                            ...
                            initial={{ opacity: 0, scale: 0.5 }}
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 3.6 }} // Notas avinatadas entra después
                        >
                            <span className="w-[1.2vh] h-[1.2vh] rounded-full bg-[#87247A] inline-block"></span>
